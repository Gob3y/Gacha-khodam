...
local CONFIG_KEYS = {
    ...
    "fpsBoost", "highGraphics", "webhookEnabled", "webhookUrl", "webhookInterval",
    "autoExecute", "autoExecUrl", "uiScale", "uiKeybindName"
}
local CONFIG_KEYSET = {}
...
local function queueAutoExecute()
    ...
    local url = tostring(S.autoExecUrl or "")
...
corner(Main, 22); stroke(Main, Color3.fromRGB(80,80,80), 1, 0.15)
...
new("Frame", { Name = "TopBarBottomFill", Size = UDim2.new(1,0,0,22), Position = UDim2.new(0,0,1,-22), BackgroundColor3 = T.Top, BorderSizePixel = 0, ZIndex = 1 }, TopBar)
...
addToggle(SettingsPage, "AUTO EXECUTE AFTER HOP", S.autoExecute, function(v) S.autoExecute = v end)
addInput(SettingsPage, "AUTO EXECUTE URL", "raw loader url", S.autoExecUrl, function(text) S.autoExecUrl = text or "" end)
