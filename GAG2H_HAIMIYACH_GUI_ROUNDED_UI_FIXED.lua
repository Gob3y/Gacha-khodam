-- // ============================================================ \\ --
-- //          Haimiyach  |  Grow a Garden 2  (full auto)        \\ --
-- // ============================================================ \\ --
...
corner(Main, 20); stroke(Main, Color3.fromRGB(80,80,80), 1, 0.15)
...
corner(TabBar, 18); stroke(TabBar, Color3.fromRGB(60,60,60), 1, 0.35); pad(TabBar, 8, 8, 6, 6)
...
corner(Content, 18); stroke(Content, Color3.fromRGB(60,60,60), 1, 0.35)
...
addSection(FarmPage, "SELL WHEN FULL")
addToggle(FarmPage, "AUTO SELL WHEN FULL", false, function(v) S.autoSell = v end)
addSection(FarmPage, "SELL SETTINGS")
addSlider(FarmPage, "AUTO SELL INTERVAL", 3, 120, S.sellInterval, 0, function(v) S.sellInterval = v end)
