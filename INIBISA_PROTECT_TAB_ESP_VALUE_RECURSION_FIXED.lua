...
addSlider(UI.Pages["AUTO"], "SELL DELAY (SEC)", 3, 120, S.sellInterval, 0, function(v) S.sellInterval = v end)
...
addSlider(UI.Pages["AUTO"], "SEED EVENT DELAY (SEC)", 3, 60, S.seedEventDelay, 0, function(v) S.seedEventDelay = v end)
addSection(UI.Pages["AUTO"], "DAILY DEALS")
addToggle(UI.Pages["AUTO"], "AUTO DAILY DEALS", S.autoDaily, function(v) S.autoDaily = v end)
addSlider(UI.Pages["AUTO"], "DAILY CLAIM DELAY (SEC)", 10, 300, S.dailyDelay, 0, function(v) S.dailyDelay = v end)
...
addSlider(UI.Pages["AUTO"], "SHOVEL DELAY (SEC)", 1, 30, S.shovelDelay, 0, function(v) S.shovelDelay = v end)
...
addSlider(UI.Pages["AUTO"], "TROWEL DELAY (SEC)", 1, 30, S.trowelDelay, 0, function(v) S.trowelDelay = v end)
...
addSlider(UI.Pages["AUTO"], "FAVORITE DELAY (SEC)", 1, 30, S.favoriteDelay, 0, function(v) S.favoriteDelay = v end)
...
addSlider(UI.Pages["PETS"], "PET BUY DELAY (SEC)", 2, 60, S.petBuyInterval, 0, function(v) S.petBuyInterval = v end)
...
addSlider(UI.Pages["OPEN"], "OPEN DELAY (SEC)", 1, 30, S.openInterval, 0, function(v) S.openInterval = v end)
