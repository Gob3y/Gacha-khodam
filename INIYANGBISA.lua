...
function HaimiyachGAG2_ChooseSprinklerPosition(placed)
    ...
    if mode == "AVATAR POSITION" then
        local hrp = root()
        origin = hrp and hrp.Position or HaimiyachGAG2_PlotCenterPosition()
    else
        origin = HaimiyachGAG2_PlotCenterPosition()
    end
    ...
    if mode ~= "AVATAR POSITION" then
        ...
        for i = 1, math.min(#grid, 50) do candidates[#candidates + 1] = grid[i] end
    end
    local seen = {}
