...
local S = {
    ...
    autoSell = false, sellInterval = 15, sellKeepMutations = {},
    ...
    autoFavoriteFruits = false, favoriteFruitTargets = {}, favoriteMutations = {}, favoriteFruitFilter = "", favoriteMinKg = 0, favoriteMaxKg = 0, favoriteMutationFilter = "", unfavoriteNotMatching = false, favoriteDelay = 3,
    -- boosts
...
local CONFIG_KEYS = {
    ...
    "autoSell", "sellInterval", "sellKeepMutations", "autoExpand", "autoPot", "autoDaily", "dailyDelay",
    "autoClaimSeedEvent", "claimUseFly", "seedEventDelay", "autoShovelPlants", "autoShovelFruits", "shovelPlantTargets", "shovelFruitTargets", "shovelMaxKg", "shovelNameFilter", "shovelDelay",
    "autoFavoriteFruits", "favoriteFruitTargets", "favoriteMutations", "favoriteFruitFilter", "favoriteMinKg", "favoriteMaxKg", "favoriteMutationFilter", "unfavoriteNotMatching", "favoriteDelay",
...
function HaimiyachGAG2_ProtectSellMutations()
    if not picked(S.sellKeepMutations) then return 0 end
    local protected = 0
    for _, tool in ipairs(HaimiyachGAG2_GetInventoryFruitTools()) do
        local mutation = tool:GetAttribute("Mutation")
        if mutation and HaimiyachGAG2_SelectedNameMatch(mutation, S.sellKeepMutations) then
...
createTab("AUTO", 3)
local ShopPage = createTab("SHOP", 4)
...
addSlider(UI.Pages["AUTO"], "SHOVEL MAX KG", 0, 100, S.shovelMaxKg, 1, function(v) S.shovelMaxKg = v end)
...
addSlider(UI.Pages["AUTO"], "FAVORITE MIN KG", 0, 100, S.favoriteMinKg, 1, function(v) S.favoriteMinKg = v end)
addSlider(UI.Pages["AUTO"], "FAVORITE MAX KG", 0, 100, S.favoriteMaxKg, 1, function(v) S.favoriteMaxKg = v end)
