...
local label = Instance.new("TextLabel")
label.Name = "Text"
label.Text = "Total Value Fruits Garden: 0c"
label.Size = UDim2.new(1, 0, 1, 0)
label.BackgroundTransparency = 1
label.BorderSizePixel = 0
...
if label then
label.Text = "Total Value Fruits Garden: " .. GardenESP.money(totalValue) .. "c"
end
end
...
if value then bottom = bottom .. " | " .. GardenESP.money(value) .. "c" end
end
local label = gui:FindFirstChild("Text")
if label then
...
if total then
total.Text = "Total Value: " .. BackpackESP.money(data.total) .. "c"
...
text = BackpackESP.money(value) .. "c"
end
...
if type(S.espWildPetDetails) ~= "table" or S.espWildPetDetails.PRICE then lines[#lines + 1] = fmt(w.price or 0) .. "c" end
...
BorderSizePixel = 0,
Text = (multi and (selected[op] and "v " or "") or "") .. cleanUiText(op),
...
return BackpackESP.money(data.total) .. "c"
end
return "?"
end
