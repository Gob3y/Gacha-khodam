...
local BoostPage = createTab("BOOSTS", 4)
local PetsPage = createTab("PETS", 5)
local OpenPage = createTab("OPEN", 6)
...
addSection(FarmPage, "SELL")
addToggle(FarmPage, "AUTO SELL WHEN FULL", false, function(v) S.autoSell = v end)
...
addDropdown(ShopPage, "SEEDS TO BUY", SEED_NAMES, {}, true, function(sel) pickMulti(sel, S.buySeeds) end)
addToggle(ShopPage, "AUTO BUY SEEDS", false, function(v) S.autoBuy = v end)
addSlider(ShopPage, "SEED BUY INTERVAL", 1, 30, S.buyInterval, 0, function(v) S.buyInterval = v end)
...
addToggle(ShopPage, "AUTO BUY GEAR", false, function(v) S.autoGear = v end)
addSlider(ShopPage, "GEAR BUY INTERVAL", 2, 60, S.gearInterval, 0, function(v) S.gearInterval = v end)
addSection(ShopPage, "DAILY DEALS")
addToggle(ShopPage, "AUTO DAILY DEALS", false, function(v) S.autoDaily = v end)
...
fpsBoostToggle = addToggle(VisualsPage, "FPS BOOST", false, function(v)
    SetFPSBoostEnabled(v)
    if v and highGraphicsToggle then
        highGraphicsToggle.Set(false, false)
    end
end)
highGraphicsToggle = addToggle(VisualsPage, "HIGH GRAPHICS", false, function(v)
