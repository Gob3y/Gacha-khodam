...
addToggle(UI.Pages["MISC"], "AUTO SERVER HOP", S.autoHop, function(v) S.autoHop = v end)
addSlider(UI.Pages["MISC"], "SERVER HOP DELAY (MIN)", 0, 120, S.hopInterval / 60, 0, function(v) S.hopInterval = v * 60 end)
addToggle(UI.Pages["MISC"], "AUTO EXECUTE AFTER HOP", S.autoExecute, function(v) S.autoExecute = v end)
...
addInput(UI.Pages["SETTINGS"], "WEBHOOK URL", "https://discord.com/api/webhooks/...", S.webhookUrl, function(text) S.webhookUrl = text or "" end)
addToggle(UI.Pages["SETTINGS"], "ENABLE REPORTS", S.webhookEnabled, function(v) S.webhookEnabled = v end)
addToggle(UI.Pages["SETTINGS"], "DISCONNECT WEBHOOK", S.webhookDisconnect, function(v) S.webhookDisconnect = v end)
addSlider(UI.Pages["SETTINGS"], "REPORT DELAY", 1, 60, S.webhookInterval / 60, 0, function(v) S.webhookInterval = v * 60 end)
