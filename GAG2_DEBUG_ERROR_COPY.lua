--[[ HAIMIYACH DEBUG RUNNER - TEMPORARY DEBUG ONLY ]]
local __HAIMIYACH_OK, __HAIMIYACH_ERR = xpcall(function()
-- // ============================================================ \\ --
...
if not __HAIMIYACH_OK then
    local msg = "[HAIMIYACH EXEC ERROR] " .. tostring(__HAIMIYACH_ERR)
    warn(msg)
    pcall(function() print(msg) end)
    pcall(function() setclipboard(tostring(__HAIMIYACH_ERR)) end)
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "HAIMIYACH ERROR",
            Text = "Runtime error copied to clipboard / console",
            Duration = 8
        })
    end)
end
