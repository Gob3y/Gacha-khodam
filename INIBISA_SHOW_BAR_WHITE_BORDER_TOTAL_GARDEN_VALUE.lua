...
local ShowButton = new("TextButton", {
    ...
    Size = UDim2.fromOffset(isMobile and 245 or 285, isMobile and 30 or 32),
...
stroke(ShowButton, Color3.fromRGB(255, 255, 255), 1.4, 0.10)

local showPadding = Instance.new("UIPadding")
showPadding.PaddingLeft = UDim.new(0, 10)
showPadding.PaddingRight = UDim.new(0, 10)
showPadding.Parent = ShowButton
...
do
    ...
    task.spawn(function()
        while not S.killed do
            ...
            ShowButton.Text = "HAIMIYACH HUB | " .. fpsText .. " FPS | " .. pingText .. " ms"
