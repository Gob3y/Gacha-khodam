...
local S = {
    ...
    killed = false,
    -- DELETE PLANTS (manual delete other players' plants)
    autoDeletePlants = false,  -- unused, only for state consistency
}
...
addButton(UI.Pages["AUTO"], "DELETE OTHER PLANTS NOW", function()
    local count = HaimiyachGAG2_HamaPlants()
    notify("DELETE", "Deleted " .. count .. " plants", 3)
end)
